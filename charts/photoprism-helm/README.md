This chart is a copy of [a fork](https://github.com/sarumontn/photoprism-helm). I have an [outstanding PR](https://github.com/p80n/photoprism-helm/pull/9) against the upstream which is over a year stale at this point. I'm copying this chart into my homelab repo to allow publication with my other custom charts.
...
```bash
helm repo add sarumont https://sarumont.github.io/homelab/
helm install photoprism sarumont/photoprism --set persistence.enabled=false
```
...
```bash
helm install photoprism sarumont/photoprism --create-namespace --namespace photoprism -f values.yaml
```
...
```bash
$ helm install photoprism sarumont/photoprism-helm -f values.yaml
```
...
```bash
$ helm install photoprism sarumont/photoprism-helm \
